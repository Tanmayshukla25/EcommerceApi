            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-5 border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-700"> discountedPrice</span>
        ...
        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
          <div className="flex gap-3 justify-end">
            ...
            <button
              ...
              className="bg-gradient-to-r from-gray-800 to-gray-600 p-6  hover:from-gray-800 hover:to-gray-500 text-white font-bold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
            >
              Place Order
            </button>
          </div>
